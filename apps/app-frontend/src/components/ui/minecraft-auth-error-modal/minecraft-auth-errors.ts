...
export const minecraftAuthErrors: MinecraftAuthError[] = [
	{
		...
		whatHappened:
			'Your saved Microsoft sign-in token has expired or was revoked, so Refract cannot refresh your Minecraft session.',
		stepsToFix: [
			'Sign out of the affected Minecraft account in Refract',
	...
	},
	{
		...
		whatHappened:
			"Minecraft's authentication service is returning a server error, so Refract cannot finish signing you in right now.",
		stepsToFix: [
	...
	},
	{
		...
		stepsToFix: [
			...
			'Try signing in to Refract again',
		],
	},
	{
		matches: (message) =>
		...
		whatHappened:
			'Refract could not connect to a Microsoft, Xbox, or Minecraft service needed for sign-in. This is usually caused by a local network, DNS, proxy, firewall, hosts file, VPN, or antivirus issue.',
		stepsToFix: [
			'Restart Refract and try signing in again',
			'Check that your internet connection is working',
			'Allow Refract through your firewall, antivirus, proxy, VPN, and hosts file rules',
	...
	},
	{
		...
		whatHappened:
			'Xbox services rejected the request to authorize this account for Minecraft services, but did not return a specific account restriction that Refract recognizes.',
		stepsToFix: [
			'Sign in with the <a href="https://www.minecraft.net/en-us/download">official Minecraft Launcher</a>',
