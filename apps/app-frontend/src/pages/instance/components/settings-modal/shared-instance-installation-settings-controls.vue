...
const messages = defineMessages({
	...
	unpublishModalBody: {
		...
		defaultMessage:
			"This deletes the shared instance from Modrinth's servers. People using it in Refract will stop receiving updates, but your local instance and its content will stay on this device.",
	},
	unlinkModalHeader: {
