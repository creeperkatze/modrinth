...
pub mod data {
    pub use crate::state::{
        ...
        ContentPlatform, CreateInstance, Credentials, Dependency,
        DetectedExternalFile, DirectoryInfo, EditInstance,
        ExternalContentSource, ExternalDetectionCandidate, ExternalPlatform,
        Hooks, InstallExternalFileRequest, InstanceIconBackground,
